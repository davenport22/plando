...
2.  **Body (HTML):**
    ...
    *   Include a prominent call-to-action (a button is preferred) that links to the registration page. The link MUST be to the registration page with the tripId query parameter: "/register?tripId={{tripId}}"
